...
## Decision rules
- No extracted decision rules; escalate to a profile or the full kernel when thresholds or exact source detail matter.

## Failure traps
- No extracted failure traps; escalate if the runtime summary is not specific enough for the task.

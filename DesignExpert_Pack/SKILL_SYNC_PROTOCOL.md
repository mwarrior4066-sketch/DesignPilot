...
Every runtime skill file in `skills/` must begin with this YAML block:

```yaml
---
skill_version: 1.0.0
source_reference:
  - knowledge-base/summaries/example-summary.md
  - knowledge-base/source-docs/example-source.md
...
## Enforcement
After any sync or edit affecting `skills/` or `knowledge-base/summaries/`, run `python3 lint_pack.py`.

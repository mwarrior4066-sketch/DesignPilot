...
- `AI Operator Pack Validation & Stress Testing.docx` -> `knowledge-base/source-docs/AI Operator Pack Validation & Stress Testing.md`

- `knowledge-base/source-docs/Technical Reference Framework for Pantone Systems and Production-Aware Design Operations.md` is stored as markdown because it is text-heavy and operational.


## Machine-readable library indexes
- `libraries/COLOR_LIBRARY.json` — compact machine-readable digital color-system index for low-token lookup
- `libraries/PANTONE_LIBRARY.json` — compact machine-readable Pantone index for low-token lookup
- `libraries/FONT_LIBRARY.json` — compact machine-readable font index for low-token lookup

...
## Load order
- `libraries/COLOR_LIBRARY.json` then `libraries/COLOR_LIBRARY.md` for digital/system work
- `pantone-production-summary.md` and `libraries/PANTONE_LIBRARY.*` only when print awareness or Pantone matching is actually in scope
...
## Hand off to
- `libraries/COLOR_LIBRARY.json`, `libraries/COLOR_LIBRARY.md` for digital palette retrieval and domain fit

...
- route selection and pathway metadata: `schemas/routing_registry.json`
- task-level output requirements: `schemas/task_contracts.json`
- validation rules and failure taxonomy: `schemas/validation_rules.json`
...
- startup aides: `runtime/boot/core_bootstrap.md`, `runtime/boot/runtime_precedence.md`
- per-route runtime cards: `runtime/cards/routes/*.json`
- per-contract runtime cards: `runtime/cards/contracts/*.json`
- per-skill runtime cards: `runtime/cards/skills/*.md`
- per-summary runtime layer: `knowledge-base/runtime-summaries/*.md`
- source-doc section escalation index: `knowledge-base/indices/source_doc_sections.json`
- route-to-summary loading map: `knowledge-base/indices/runtime_summary_map.json`

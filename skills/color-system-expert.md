...
## Read these first
- `knowledge-base/summaries/color-and-accessibility-summary.md`
- `libraries/COLOR_LIBRARY.json`, `libraries/COLOR_LIBRARY.md` for digital/system work
- `knowledge-base/summaries/pantone-production-summary.md` plus `libraries/PANTONE_LIBRARY.*` only when print-aware

...
- `knowledge-base/source-docs/pantone_color_chart.pdf` for visual range browsing
...
- check the visual chart in `knowledge-base/source-docs/pantone_color_chart.pdf`

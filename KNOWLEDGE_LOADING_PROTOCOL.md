...
2. `runtime/boot/core_bootstrap.md`
3. `runtime/boot/runtime_precedence.md`
4. selected route card in `runtime/cards/routes/`
5. selected contract card in `runtime/cards/contracts/`
6. only the required skill cards in `runtime/cards/skills/`
7. only the mapped runtime summaries in `knowledge-base/runtime-summaries/`

...
canonical_summary: src/knowledge-base/summaries/grid-mediums-summary.md
last_generated: 2026-04-11
overlay: true
source_reference:
  - src/knowledge-base/source-docs/Grid Systems Guide_ Presentation, App, Web.md
  - src/knowledge-base/source-docs/AI PDF Creation_ Grid and Typography.md
---
# Grid Mediums Summary Runtime Summary

## Decision rules
- No extracted decision rules; fall back to the canonical summary.

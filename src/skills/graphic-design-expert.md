...
- `src/knowledge-base/summaries/document-presentation-architecture-summary.md` when the task is a deck, report, or presentation PDF
- `src/knowledge-base/summaries/pantone-production-summary.md` when print-aware
- `src/libraries/PANTONE_LIBRARY.json`, `src/libraries/PANTONE_LIBRARY.md` when print-aware
- `src/libraries/FONT_LIBRARY.json`, `src/libraries/FONT_LIBRARY.md` when type choice is active
...
## Useful thresholds
- live decks should usually target one dominant claim or concept per slide; if multiple concepts are competing, split the slide
- long decks should use cover, TOC, divider, content, and close roles when the audience needs wayfinding
- dark decks should prefer warm/cool dark shifts over hard dark/light inversion when continuity matters
- persistent chrome should identify the section; local headlines should not repeat the same label
...
<!-- Auto-generated runtime overlay. Edit src/skills/graphic-design-expert.md -- not this section. -->

...
source_reference:
  ...
  - src/knowledge-base/summaries/typeface-database-summary.md
...
## Purpose
Use this skill to choose, compare, pair, substitute, and deploy typefaces intelligently across UI, editorial, brand, dashboards, presentations, print, accessibility-sensitive, and multilingual systems.
...
- specify script-aware fallback stacks when relevant
...
- smaller text may need stronger weight, spacing, opsz support, or a more readable family altogether
...
- if the product is multilingual, define script-aware fallback stacks instead of pretending one Latin family covers everything
...
- role map
- script coverage note when relevant
- measure target
- leading ratio
...
<!-- Auto-generated runtime overlay. Edit src/skills/type-system-expert.md -- not this section. -->
...
## Canonical fallback
- `src/skills/type-system-expert.md`
- `src/knowledge-base/summaries/typography-summary.md`
- `src/knowledge-base/summaries/typeface-database-summary.md`

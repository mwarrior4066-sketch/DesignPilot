...
- `/src/knowledge-base/source-docs/` = human-provided or canonical converted sources. Treat as **read-only**.
- `/src/knowledge-base/source-media/` = preserved media extracted from source docs. Treat as **read-only**.
- `/src/knowledge-base/summaries/` = AI-usable distilled references derived from source docs.
- `/src/knowledge-base/indices/` = AI-managed navigation maps for fast retrieval.

## 2. Population protocol
- The pack is not knowledge-ready unless `/src/knowledge-base/source-docs/` contains foundational project or standards documents.

...
4. selected route card in `src/runtime/cards/routes/`
5. selected contract card in `src/runtime/cards/contracts/`
6. only the required skill cards in `src/runtime/cards/skills/`
7. only the mapped runtime summaries in `src/knowledge-base/runtime-summaries/`

...
def refresh_project(slug: str = 'designpilot'):
    ...
    project_overview.write_text(
        '# Project Overview\n\n'
        'DesignPilot is the flagship project used to prove the DesignPilot system can operate as a routed, evidence-constrained design operator system without overstating proof. '
